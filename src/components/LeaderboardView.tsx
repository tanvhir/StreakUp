...
export const LeaderboardView: React.FC<LeaderboardViewProps> = ({
  ...
  return (
    <div className="max-w-2xl mx-auto px-3 sm:px-4 py-4 sm:py-6 space-y-5 pb-24 lg:pb-6 animate-fade-in">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center flex-wrap gap-1.5 mt-1">
                      ...
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded-lg whitespace-nowrap ${
                        ...
                        Today: {item.todayLog ? formatMinutesToHM(Number(item.todayLog.studyMinutes) || 0) : 'Pending'}
                      </span>
                    </div>
                  </div>
                </div>
